...
using Control.Entities.Models.Autor;
...
{
    public class AutorAccountController : Controller
    {
        private UserManager<ApplicationUser> userManager;
        private RoleManager<ApplicationRole> roleManager;

        public AutorAccountController()
        {
        ...
        //[Authorize(Roles = "Admin")]
        public ActionResult RegisterHelpers()
        {
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult RegisterHelpers(Register model)
        {
            if (ModelState.IsValid)
            {
                ApplicationUser user = new ApplicationUser();
        ...
        //[Authorize(Roles = "Admin")]
        public ActionResult RegisterAsistants()
        {
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult RegisterAsistants(Register model)
        {
            if (ModelState.IsValid)
            {
                ApplicationUser user = new ApplicationUser();
