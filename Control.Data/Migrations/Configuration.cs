namespace Control.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Control.Data.Data.ApplicationDbContext>
    {
        ...
        protected override void Seed(Control.Data.Data.ApplicationDbContext context)
        {
            //CreateRoles(context);
            //CreateAdmin(context);
        }
